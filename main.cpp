...
int main(int argc, char *argv[])
{
    ...
    auto filename = "/home/student/CLionProjects/Dijkstra/USA-road-d.NY.gr";
   ...
   // Creating parallel Dijkstra-graph
    ...
    par.createGraph();
    auto end_create_graph = chrono::high_resolution_clock::now() - start_create_graph;
    ...
    par.execGraph();
    auto end_exec_graph = chrono::high_resolution_clock::now() - start_exec_graph;
    ...
    seq.createGraph();
    auto end_create_graph_seq = chrono::high_resolution_clock::now() - start_create_graph_seq;
    ...
    seq.execGraph();
    auto end_exec_graph_seq = chrono::high_resolution_clock::now() - start_exec_graph_seq;
    ...
    do {
        ...
        if(dest > 0){
            ...
            cout <<"Printing parallel graph: " << microseconds_hop_graph <<  " us" << endl;
